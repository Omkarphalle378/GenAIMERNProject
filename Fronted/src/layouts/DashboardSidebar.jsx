    ...
    <aside className={`dashboard-sidebar ${isOpen ? 'dashboard-sidebar--open' : ''}`}>
      ...
      <div className='sidebar-profile' onClick={() => handleNav('/profile')}>
        ...
        <div className='sidebar-profile__details'>
          <p className='sidebar-profile__name'>{user?.username || 'Candidate'}</p>
          <span className='sidebar-profile__status'>{user?.email || 'View account'}</span>
        </div>
      </div>
